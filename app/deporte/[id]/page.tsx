...
const deportes = {
  "salto-pasiego": {
    ...
    historia:
      `<p> El salto pasiego es una técnica tradicional de los habitantes de los Valles Pasiegos en Cantabria.Utilizando un palo largo como pértiga, los pasiegos saltaban sobre los arroyos, muros de piedra y terrenos accidentados mientras se desplazaban con sus ganados por las laderas montañosas.Esta práctica surgió como una necesidad para moverse por el terreno escarpado de la región, y con el tiempo se convirtió en una habilidad distintiva y en una competición deportiva.</p>

      <p class="list-disc pt-6">Durante nuestra jornada, tuvimos el privilegio de contar con la participación de <strong>Adrián García</strong> y <strong>Alejandro Fernández</strong>, quienes no solo nos ofrecieron una explicación detallada sobre el origen y la evolución de cada una de las modalidades del salto pasiego, sino que también realizaron una demostración práctica de las mismas. Su intervención fue fundamental para comprender la riqueza técnica y simbólica de este deporte tradicional.</p>

      <p class="list-disc pt-6">Gracias a sus explicaciones pudimos conocer de primera mano las diferencias entre el <em>salto al palo</em>, el <em>triple salto</em>, el <em>rayar al palo</em> y el <em>andar al palo</em>, entendiendo tanto la dificultad como la preparación que cada una de estas pruebas exige. Su dominio técnico y entusiasmo ayudaron a acercarnos aún más a esta práctica ancestral, subrayando el valor que tiene preservar y transmitir este legado cultural.</p>

      <p class="list-disc pt-6"><em>Dato curioso:</em> Aunque pueda parecer una disciplina puramente deportiva, el salto pasiego ha sido objeto de estudio por su vínculo directo con la vida ganadera y la movilidad ancestral en terrenos de alta montaña. Su práctica continúa siendo un símbolo de identidad cultural para las comunidades de Cantabria.</p>

    `,
    reglas:
      `<p class="pb-6">En la competición moderna del salto pasiego, una disciplina tradicional de los Valles Pasiegos en Cantabria, se reconocen cuatro modalidades reglamentadas que ponen a prueba la destreza, fuerza y técnica de los participantes. A continuación, se describen sus reglas:</p>

      <h3><strong>1. Salto al palo</strong></h3>
      <p>Esta es la modalidad más representativa del salto pasiego. El participante corre con el palo en la mano y lo clava firmemente en el suelo en un punto elegido estratégicamente. A partir de ahí, se impulsa hacia arriba y hacia adelante utilizando el palo como pértiga.</p>
      <ul class="list-disc pl-6 pb-6">
        <li>El objetivo es alcanzar la máxima longitud posible y caer con control sobre los pies en la zona marcada.</li>
        <li>El salto debe realizarse sin que el participante suelte el palo antes de aterrizar.</li>
      </ul>

      <h3><strong>2. Triple salto</strong></h3>
      <p>Inspirado en el triple salto del atletismo, esta modalidad consiste en una secuencia de tres saltos consecutivos.</p>
      <ul class="list-disc pl-6 pb-6">
        <li>El primer salto se hace desde una línea de salida, impulsándose con una pierna.</li>
        <li>El segundo salto se ejecuta con la pierna contraria, y el tercero culmina con una caída controlada lo más lejos posible.</li>
        <li>Se mide la distancia total desde el punto de despegue hasta la marca más cercana dejada por cualquier parte del cuerpo en la caída.</li>
      </ul>

      <h3><strong>3. Rayar al palo</strong></h3>
      <p>Una modalidad que combina precisión y técnica. El objetivo es clavar el palo lo más cerca posible de una línea horizontal previamente marcada en el suelo.</p>
      <ul class="list-disc pl-6 pb-6">
        <li>El participante se lanza en carrera y clava el palo en el terreno intentando que la punta toque la línea marcada.</li>
        <li>No se permite arrastrar el palo ni retroceder después del salto.</li>
        <li>La distancia entre la línea y la marca real del palo se mide al milímetro, y gana quien logre mayor precisión.</li>
        <li>Se realizan varias rondas eliminatorias y clasificatorias para desempates.</li>
      </ul>

      <h3><strong>4. Andar al palo</strong></h3>
      <p>Esta es una prueba de resistencia y equilibrio que simula el uso tradicional del palo pasiego como herramienta de desplazamiento.</p>
      <ul class="list-disc pl-6 pb-6">
        <li>El participante debe recorrer una distancia establecida caminando con ayuda del palo, apoyándolo en cada paso.</li>
        <li>Está prohibido correr, trotar o dejar de usar el palo como punto de apoyo principal.</li>
        <li>Se evalúa la distancia, el tiempo total, la postura y la técnica durante el recorrido.</li>
      </ul>

      <p>Estas cuatro modalidades reflejan tanto la riqueza etnográfica del salto pasiego como su adaptación a un contexto deportivo moderno. Además de su componente competitivo, estas pruebas mantienen vivo un patrimonio inmaterial único en el norte de España.</p>
      `,
    imagenes: [
    ...
    enlacesTexto: {
      ...
      "Adrián García": "/perfiles/adrian-garcia",
      "identidad cultural": "https://www.vallespasiegos.eu/la-tradicion-del-salto-pasiego/?utm_source=chatgpt.com",
    }
  },
  "bolo-palma": {
    nombre: "Bolo palma",
